...
type Config struct {
	Settings struct {
		...
		AddressGRPC    string        `yaml:"address_grpc" env:"ADDRESS_GRPC" json:"address_grpc,omitempty"`
...
func GetConfig() *Config {
	...
	flag.StringVar(&cfg.Settings.AddressGRPC, "g", "", "grpc address to send metrics")
